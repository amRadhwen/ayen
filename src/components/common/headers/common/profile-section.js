...
export default function Profilesection({handleSignout}) {
    ...
    const profile_pic = user && user.avatar ? user.avatar : `${process.env.PUBLIC_URL}/assets/images/icon/users.png`;
    ...
    return(
        <div className='profile-section'>
            <ul className='profile-section-list'>
                ...
                <li><Link to="/vendor-profile"><img className="profile_avatar" src={profile_pic} alt="profile.png"/></Link></li>
